...
class Options(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--data_root', type=str, default="GAN/GANdatasets/celebA", help='paths to GANdata set.')
        parser.add_argument('--img_path', type=str, default="input.jpg", help='path to image')
        ...
        parser.add_argument('--n_threads', type=int, default=6, help='number of workers to load GANdata.')
